...
def places(city_id):
	...
	Raises:
		404: If specified city_id does not exist
	"""
...
def create_place(city_id):
	"""Create places in a city
	Args:
		city_id (str): ID of City where place will be created
	Returns:
		dict: The created place
	Raises:
		404: If specified city_id does not exist
		400: If request body is not a valid JSON or if it is missing the
			 user_id or name
	"""
